...
@Controller
@RequestMapping("/admin/importdata/staff")
...
public class ImportStaffController {	
	...
	private static Logger logger = Logger.getLogger(ImportStaffController.class);	 	
	...
	public ModelAndView initProfile() {
		...
		mav.setViewName("initImportStaff");  
		try{
				...
				if (originalfile.getSize() > pathUtil.getMaximumImageUploadSize()) {
					...
					while(isnext){
						...
						case 5 :
							...
							importProfileService.readStaffWorkbook (workbook, httpRequest);
							step++; 
						default:
							isnext = false;
						}
