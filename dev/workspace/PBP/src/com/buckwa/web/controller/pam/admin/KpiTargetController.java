...
public class KpiTargetController {
	private static Logger logger = Logger.getLogger(KpiTargetController.class);
	...
	@RequestMapping(value = "kpitargetLevel1.htm", method = RequestMethod.GET)
	public ModelAndView kpitargetLevel1(HttpServletRequest httpRequest, @RequestParam("yearId") String yearId, @RequestParam("groupId") String groupId) {
		logger.info(" Start  ");
		ModelAndView mav = new ModelAndView();
		mav.addObject(BuckWaConstants.PAGE_SELECT, BuckWaConstants.ADMIN_INIT);
		BuckWaRequest request = new BuckWaRequest();
		mav.setViewName("kpitargetLevel1");
		KpiTemplate kpi = new KpiTemplate();
		try {
	...
	@RequestMapping(value = "initEditkpitargetLevel1.htm", method = RequestMethod.GET)
	public ModelAndView initEditkpitargetLevel1(HttpServletRequest httpRequest, @RequestParam("yearId") String yearId, @RequestParam("groupId") String groupId) {
		logger.info(" Start  ");
		ModelAndView mav = new ModelAndView();
		mav.addObject(BuckWaConstants.PAGE_SELECT, BuckWaConstants.ADMIN_INIT);
		BuckWaRequest request = new BuckWaRequest();
		mav.setViewName("initEditkpitargetLevel1");
		KpiTemplate kpi = new KpiTemplate();
		try {
			httpRequest.getSession().setAttribute("yearId", yearId);
			httpRequest.getSession().setAttribute("groupId", groupId);
	...
	@RequestMapping(value = "kpitargetLevel2.htm", method = RequestMethod.GET)
	public ModelAndView kpitargetLevel2(HttpServletRequest httpRequest, @RequestParam("yearId") String yearId, @RequestParam("groupId") String groupId) {
		logger.info(" Start  ");
		ModelAndView mav = new ModelAndView();
		mav.addObject(BuckWaConstants.PAGE_SELECT, BuckWaConstants.ADMIN_INIT);
		BuckWaRequest request1 = new BuckWaRequest();
		mav.setViewName("kpitargetLevel2");
		KpiTemplate kpi = new KpiTemplate();
		try {
			httpRequest.getSession().setAttribute("yearId", yearId);
			httpRequest.getSession().setAttribute("groupId", groupId);
	...
	@RequestMapping(value = "initEditkpitargetLevel2.htm", method = RequestMethod.GET)
	public ModelAndView initEditkpitargetLevel2(HttpServletRequest httpRequest, @RequestParam("yearId") String yearId, @RequestParam("groupId") String groupId) {
		logger.info(" Start  ");
		ModelAndView mav = new ModelAndView();
		mav.addObject(BuckWaConstants.PAGE_SELECT, BuckWaConstants.ADMIN_INIT);
		BuckWaRequest request = new BuckWaRequest();
		mav.setViewName("initEditkpitargetLevel2");
		KpiTemplate kpi = new KpiTemplate();
		try {
			httpRequest.getSession().setAttribute("yearId", yearId);
			httpRequest.getSession().setAttribute("groupId", groupId);
...
//				personMappingEvaluateService.endEvaluateSession(request);
			...
			return kpitargetLevel2(httpRequest,yearId,groupId);
