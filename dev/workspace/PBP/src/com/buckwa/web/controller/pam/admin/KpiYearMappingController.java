...
@Controller
@RequestMapping("/admin/kpiyear")
@SessionAttributes(types = KpiYearMapping.class)
public class KpiYearMappingController {
	private static Logger logger = Logger.getLogger(KpiYearMappingController.class);
	...
	@RequestMapping(value = "getTemplateByYearAndGroupId.htm", method = RequestMethod.GET)
	public ModelAndView getTemplateByYearAndGroupId(HttpServletRequest httpRequest, @RequestParam("yearId") String yearId, @RequestParam("groupId") String groupId) {
		logger.info(" Start  ");
		ModelAndView mav = new ModelAndView();
		mav.addObject(BuckWaConstants.PAGE_SELECT, BuckWaConstants.ADMIN_INIT);
		BuckWaRequest request = new BuckWaRequest();
