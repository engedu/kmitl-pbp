 ...
 */
public class PersonalLeave extends BaseDomain {

	private Long leavePersonalId;
	...
	public Long getLeavePersonalId() {
		return leavePersonalId;
	}

	public void setLeavePersonalId(Long leavePersonalId) {
		this.leavePersonalId = leavePersonalId;
	}
	...
	public int getCanPersonalDay() {
		return canPersonalDay;
	}

	public void setCanPersonalDay(int canPersonalDay) {
		this.canPersonalDay = canPersonalDay;
	}
