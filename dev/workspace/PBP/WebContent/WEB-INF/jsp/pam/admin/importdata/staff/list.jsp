	...
	<div class="entry">
		 ...
		 <div class="pbptableWrapper">
			...
			<table class="pbp-table">
				...
				<div class="pbp-header"><span class="lsf-icon colororange" title="list"></span>นำเข้าข้อมูล Staff</div> 
				</th></tr></thead>
				<tbody>
					<tr>
					<td class="tdFirst">นำเข้าข้อมูล Staff: </td>
					<td class="tdLast">						
...
<script>
	...
	function validateUpload (){		
		...
		form.action ="<%=request.getContextPath()%>	/admin/importdata/staff/upload.htm";
		form.method = 'POST';
		form.submit();
	}
