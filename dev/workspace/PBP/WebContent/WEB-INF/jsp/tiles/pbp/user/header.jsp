...
<li><sec:authorize ifAnyGranted="ROLE_USER"><a rel="notLoading" href="<%=request.getContextPath()%>/pam/person/initAcademicWork.htm"> ผลงานประจำปี</a></sec:authorize></li>
	  	 ...
	  	 <li  >    		
		    		<sec:authorize ifAnyGranted="ROLE_USER">
				  <a rel="notLoading" href="<%=request.getContextPath()%>/message/init.htm"> ข้อความ</a>	  
				 </sec:authorize>
		  </li>		
	  	 <li  >    		
		    		<sec:authorize ifAnyGranted="ROLE_USER">
				  <a rel="notLoading" href="<%=request.getContextPath()%>/personReport/init.htm"> กกรายงานคะแนน</a>	  
				 </sec:authorize>
		  </li>		
		  	  	 <li  >    		
		    		<sec:authorize ifAnyGranted="ROLE_USER">
				  <a rel="notLoading" href="<%=request.getContextPath()%>/personTimeTable/init.htm?academicYear="> ตารางสอน</a>	  
				 </sec:authorize>
		  </li>			  
	  	 <li  >    		
		    		<sec:authorize ifAnyGranted="ROLE_PRESIDENT">
				  <a rel="notLoading" href="<%=request.getContextPath()%>/president/init.htm"> อธิการบดี</a>	  
				 </sec:authorize>
		  </li>				  
		  ...
		  <!--   
	  			...
	  			<li  >    		
		    		<sec:authorize ifAnyGranted="ROLE_USER">
				  <a rel="notLoading" href="<%=request.getContextPath()%>/timeTable/init.htm"> ตารางสอน</a>	  
				 </sec:authorize>
		  </li>	
		  
		   -->	
 			<li  style="border:  none; padding-left: 5px;"> 	
		    		<sec:authorize ifAnyGranted="ROLE_USER">
