...
<form:form modelAttribute="department" action="editDepartment.htm" method="POST" name="mainForm"> 	 
...
<div class="post">
	...
	<div class="entry">
		 ...
		 <div class="pbptableWrapper">
            <div class="pbp-header"> แก้ภาควิชาที่ประจำปีการศึกษา ${department.academicYear}
			...
			<table class="pbp-table">
				<tbody>
					<tr>
					<td class="tdFirst">ภาควิชา :   
							<form:input cssClass="input" path="name"  /> <span class="require">*</span> <form:errors	path="name" cssClass="require" />					
					</td>
					<td class="tdFirst"> 
						<a rel="notLoading" href="<%=request.getContextPath()%>/admin/pbp/faculty/deleteDepartmentById.htm?departmentId=<c:out  value="${department.departmentId}"/>">
