	...
	<div class="entry">
		...
		<table width="100%" id="tableSearch">
			...
			<tbody>
				...
				<td><form:input cssClass="input" path="messageDetail" /></td>
	
				<td  align="right"><input
					value="<spring:message code="label.button.search"/>" type="submit" class="btn btn-primary"> </td>
			</tr>
			</tbody>
		</table>
		<div class="line">&nbsp;</div>
		...
		<div>
				...
				<table class="pbp-table">
					<thead>
						<tr>
							<th class="thFirst">ข้อความ</th>
							<th class="thFirst">โดย</th>
						</tr>
					</thead>
					<tbody>
						<c:if
