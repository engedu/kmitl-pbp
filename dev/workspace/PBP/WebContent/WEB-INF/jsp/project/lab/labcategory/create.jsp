...
<form:form modelAttribute="labCategory"	action="create.htm" method="POST" name="mainForm">  

	<div class="subTopicHeader">LabCategory Create &nbsp;&nbsp; 
	
	<sec:authorize ifAnyGranted="ROLE_PROJECT_SA ">
			<a href="<%=request.getContextPath()%>/project/labCategory/init.htm?name=" >
			 Manage LabCategory
