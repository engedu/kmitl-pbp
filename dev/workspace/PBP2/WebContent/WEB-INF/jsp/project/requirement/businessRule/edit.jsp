...
<form:form modelAttribute="businessRule"	action="edit.htm" method="POST" name="mainForm">  

	<div class="subTopicHeader">Business Rule Edit</div>	 
	<br> 
	<div class="usecaseHeaderTxt">
 
    <div class="usecase">       
     <div class="subTopicHeaderNoBorder"> &nbsp; <c:out value="${businessRule.code}"/>
