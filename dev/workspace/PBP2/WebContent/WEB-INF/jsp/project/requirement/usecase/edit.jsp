...
<form:form modelAttribute="useCase"	action="edit.htm" method="POST" name="mainForm" enctype="multipart/form-data" >  

	<div class="frameworkHeader">Use Case Edit</div>	 
	<br> 
        	...
        	<tr>
      		<td class="usecaseheader">Basic Flow:</td>
      		 <td  >
      		  ...
      		  <form:textarea path="basicFlow" cssClass="tinymce" rows="30" cols="85" />
			    ...
			    <table width="25%"> 
			     <c:forEach items = "${useCase.filePathList}" var="domain">   
			      <tr>
			        ...
			        &nbsp;
						<a href="<%=request.getContextPath()%>/project/requirement/useCase/removeFile.htm?fileId=<c:out value="${domain.imagePathId}"/>&usecaseId=<c:out value="${useCase.usecaseId}"/>" onclick="return confirmPage('ยืนยันการลบข้อมูล this File');" >  
			        	 Delete</a>
		 			 </td> 
			      	<td>
