					...
					<tbody>
						...
						<c:forEach items="${pagingBean.currentPageItem}" var="domain">
							<tr class="row">
								...
								<!-- 
 								<td align="left"> 
 								 								<a href="<%=request.getContextPath()%>/admin/kpitarget/kpitargetLevel1.htm?yearId=<c:out value="${domain.yearId}"/>&groupId=<c:out value="${domain.categoryId}"/>">
								View </a>
 								</td>
 								-->
 								<td align="left">
 								
 								<a href="<%=request.getContextPath()%>/admin/target/kpitargetLevel2.htm?yearId=<c:out value="${domain.yearId}"/>&groupId=<c:out value="${domain.categoryId}"/>">
								แก้ไข </a>
