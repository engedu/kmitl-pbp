					...
					<tbody>
						...
						<c:forEach items="${pagingBean.currentPageItem}" var="domain">
							<tr class="row">
								...
								<!-- 
 								<td align="left"> 
 								 								<a href="<%=request.getContextPath()%>/admin/kpilevel/kpilevelLevel1.htm?yearId=<c:out value="${domain.yearId}"/>&groupId=<c:out value="${domain.categoryId}"/>">
								View </a>
 								</td>
 								-->
 								<td align="left">
 								
 								<a href="<%=request.getContextPath()%>/admin/marklevel/kpilevelLevel2.htm?yearId=<c:out value="${domain.yearId}"/>&groupId=<c:out value="${domain.categoryId}"/>">
								แก้ไข </a>
