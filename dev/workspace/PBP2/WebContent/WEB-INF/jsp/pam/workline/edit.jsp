...
<form:form modelAttribute="workline"	action="edit.htm" method="POST" name="mainForm">   
<form:hidden path="id"/>
<form:hidden path="worklineCode"/>
<div class="post">
	<h2 class="title">สายการบังคับบัญชา > แก้ไข</h2>
	<div class="entry">
