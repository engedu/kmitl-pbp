...
<form:form modelAttribute="worklineMapping"	action="addworklinehierarchy.htm" method="POST" name="mainForm">  
 <div class="post">
	<h2 class="title">ข้อมูลสายงานบุคลากร > สร้าง </h2>
		<div class="entry">
		<table width="100%">
			<tr>
				<td class="label-form">ต้นสายบังคับบัญชา:</td>
				<td class="text">
					<form:hidden path="parentCode"/>
					<c:if test="${!empty worklineMapping.worklineName}">
