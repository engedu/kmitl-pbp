...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		$("#groupId").change(function() {
			...
			document.location.href="<%=request.getContextPath()%>/pam/evaluate/userHistoryEvaluate.htm?yearId="+year+"&semesterId="+semester;
		});
	...
	function loadSemester(yearId) {
		var group =  $("#groupId").val();
		var semester =  $("#semester-dropdown").val();
		document.location.href="<%=request.getContextPath()%>/pam/evaluate/userHistoryEvaluate.htm?yearId="+yearId;
	}
...
// 		var evaluateTerm =  '1';
		document.location.href="<%=request.getContextPath()%>/pam/evaluate/historyEvaluateForm.htm?personId="+personId+"&groupId="+groupId+"&evaluateTerm="+semester;
	}
