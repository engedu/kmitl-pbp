...
<div class="post">
	<h2 class="title">ยื่นใบลา > ใบลาอุปสมบท&nbsp;<spring:message code="${leave.cancelMsg}"/></h2>
	<div class="entry">
		...
		<table class="researchTbl">
			<tr>
				...
				<td class="text">${leave.monkhoodLeave.docNo}</td>
			</tr>
			<tr>
				<td class="label-form" width="25%">ข้าพเจ้า :</td>
				<td class="text"><spring:message code="${leave.monkhoodLeave.everStr}"/> บวช</td>
			</tr>
			<tr>
				<td class="label-form" width="25%">มีศรัทธาจะอุปสมบท ณ วัด :</td>
				<td class="text">${leave.monkhoodLeave.at}</td>
			</tr>
			<tr>
				<td class="label-form">ตั้งอยู่ ณ :</td>
				<td class="text">${leave.monkhoodLeave.location}</td>
			</tr>
			<tr>
				<td class="label-form" width="25%">กำหนดวันที่ :</td>
				<td class="text">${leave.monkhoodLeave.defindDateStr}</td>
			</tr>
			<tr>
				<td class="label-form">และจะจำพรรษา ณ วัด :</td>
				<td class="text">${leave.monkhoodLeave.stay}</td>
			</tr>
			<tr>
				<td class="label-form">ตั้งอยู่ ณ :</td>
				<td class="text">${leave.monkhoodLeave.location1}</td>
			</tr>
			<tr>
				<td class="label-form" width="25%">ตั้งแต่วันที่ :</td>
				<td class="text">${leave.monkhoodLeave.fromDateStr}</td>
			</tr>
			<tr>
				<td class="label-form" width="25%">ถึงวันที่ :</td>
				<td class="text">${leave.monkhoodLeave.toDateStr}</td>
			</tr>
			
			<tr>
				<td class="label-form" width="25%">มีกำหนด (วัน) :</td>
				<td class="text">
					${leave.monkhoodLeave.amountDay}
				</td>
			</tr>
			<tr>
				<td class="label-form" width="25%">มีวันลาอุปสมบทคงเหลือ(วัน) :</td>
				<td class="text"> 
					${leave.leaveBalance}
				</td>
			</tr>
			<tr>
				...
				<td class="text">${leave.monkhoodLeave.contactBy}</td>
			</tr>
			<tr>
		...
		<table>
			...
			<tr>
				...
				<c:if test="${leave.monkhoodLeave.flagExpired == 0 }">
...
<form:hidden path="officerApprove" />
 ...
 <script type="text/javascript">
	...
	function print (){
		var form = document.forms['mainForm']; 
		form.action ="<%=request.getContextPath()%>/leave/monkhood/print.htm";
		form.method='GET';	
		form.submit();	
	}
