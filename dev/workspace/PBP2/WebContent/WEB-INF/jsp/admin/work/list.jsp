...
<div class="post"> 
	<div class="entry">
		...
		<table class="pbp-table"> 
			...
			<div class="pbp-header"><span class="lsf-icon colororange" title="list"></span>แก้ไขข้อมูลผลงานบุคลากร ประจำปีการศึกษา ${user.academicYear}  </div>
			</thead></tr></th>
			<tr>	
				<td class="label-form">
					ชื่อผู้เข้าใช้ระบบ:
 ...
 -->
		...
		<div>
		 ...
		 -->
								...
								<a href="<%=request.getContextPath()%>/admin/work/initAcademicWork.htm?username=<c:out value="${domain.username}"/>">
