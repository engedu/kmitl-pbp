...
<div class="entry"> 
	...
	<table class="pbp-table"> 
		<thead>
			<tr>
           		<th colspan="8" align="left">    <span class="lsf-icon colororange" title="list"></span>
			...
			<tr>
				<th  class="thLast" width="100px">ประเภทภาระงาน     </th>
				<th   class="thFirst" width="70px">งาน </th>
				<th   class="thFirst" width="200px">ภาระงาน/คะแนน </th>
				<th   class="thFirst" width="30px">ลบ</th>	
				<th   class="thFirst" width="30px">สถานะ </th>	
				<th   class="thFirst" width="30px">สัดส่วน </th>			 
				<th   class="thFirst" width="80px">คะแนน
				  <br>
		...
		<tbody>
			...
			<tr>
				<td class="tdLast" style="border-bottom: 1px solid #e1e1e1; " width="100px">			
					...
					<table class="pbp-table noshadow">
					 <c:forEach items="${domain.academicKPIUserMappingList}" var="domain2" varStatus="status2">
						...
						<td class="" width="30px" style="text-align: center;">
						 <a rel="notLoading" onclick="return confirmPage('ยืนยันการลบข้อมูล  ?')" href="<%=request.getContextPath()%>/admin/work/deleteImportWork.htm?kpiUserMappingId=<c:out value="${domain2.kpiUserMappingId}"/>&username=<c:out value="${person.username}"/> ">  <span style="color: red;">Delete</span></a>
						</td>
						
						<td class="" width="40px" style="text-align: center;">
							<c:if test="${domain2.status=='CREATE'}">
	<!-- 						 <span class="require" style="font-size: 12px; color: red;" >รออนุมัติ</span> -->
							 	<img width="25px" alt="รออนุมัติ" src="data:image/png;base64," />
							</c:if>
