...
<div class="post">
	...
	<span style="font-size: 30px; color: rgb(74,132,47);"> ปีการศึกษาปัจจุบัน   ${academicYearWrapper.academicYear.name}  &nbsp; 
	ปรับปีการศึกษาเป็น  &nbsp; ${academicYearWrapper.nextAcademicYear} </span> 
